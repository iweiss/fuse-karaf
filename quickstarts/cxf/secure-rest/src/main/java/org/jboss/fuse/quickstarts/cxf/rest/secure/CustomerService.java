...
public class CustomerService {
    ...
    public Customer getCustomer(@io.swagger.annotations.ApiParam(value = "id") @PathParam("id") String id) {
    ...
    @PUT
    @Path("/customers/")
    public Response updateCustomer(@io.swagger.annotations.ApiParam(value = "customer") Customer customer) {
    ...
    @POST
    @Path("/customers/")
    public Response addCustomer(@io.swagger.annotations.ApiParam(value = "customer") Customer customer) {
    ...
    @DELETE
    @Path("/customers/{id}/")
    public Response deleteCustomer(@io.swagger.annotations.ApiParam(value = "id") @PathParam("id") String id) {
    ...
    @Path("/orders/{orderId}/")
    public Order getOrder(@io.swagger.annotations.ApiParam(value = "orderId") @PathParam("orderId") String orderId) {
